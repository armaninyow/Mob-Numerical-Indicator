...
public class MobIndicatorRenderer {
    ...
    private static final ResourceLocation GUI_ATLAS       = net.minecraft.data.AtlasIds.GUI;
    ...
    private static void submitSprite(
        ...
        collector.submitCustomGeometry(poseStack, RenderType.text(tex.atlasLocation()),
                (pose, buf) -> {
