...
public class EntityRenderCache {
    ...
    public static class Snapshot {
        ...
        public Snapshot(LivingEntity entity, float partialTick) {
            ...
            // Compute packed light the same way vanilla does in EntityRenderer.createRenderState()
            ...
            this.lightCoords = net.minecraft.client.renderer.LightTexture.pack(blockLight, skyLight);
        }
    }
